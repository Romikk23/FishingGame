...
public class Hud {
    ...
    public void getTileImage() {
        try {
            ...
            for (int i = 0; i < 10; i++) {
                coins[i] = new Tile();
                coins[i].image = ImageIO.read(getClass().getResourceAsStream("/textures/hud/coin/" + i +".png"));
            }

            coins[10] = new Tile();
            coins[10].image = ImageIO.read(getClass().getResourceAsStream("/textures/hud/coin/coin.png"));
